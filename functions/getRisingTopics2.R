...
#' @examples
#' \dontrun{
#' getRisingTopics2("apple", api.key = "YOUR_API_KEY")
#'
#' getRisingTopics2(terms="Amazon", geo = "US", property = "news",
#' startDate = "2014-01", endDate = "2014-12", api.key = "YOUR_API_KEY")
#' }



getRisingTopics2 <- function(terms, geo=NULL, property=NULL, category=NULL, startDate=NULL, endDate=NULL, api.key) {
